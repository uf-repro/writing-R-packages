...
* `roxygen2` adopts the idea of `doxygen` for R:
  - functions are documented in the comments immediately prior
  - code and documentation are in the same location - easier to maintain consistency
